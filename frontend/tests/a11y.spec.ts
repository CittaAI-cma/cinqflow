...
const DESTINATIONS: ReadonlyArray<[name: string, route: string]> = [
  ...
  ["Medallion Layers", "/data/layers"],
  ["A layer's tables", "/data/layers/silver_raw"],
  ["An unbuilt layer", "/data/layers/gold"],
  ["A layer's masked rows", "/data/layers/silver_raw/members"],
